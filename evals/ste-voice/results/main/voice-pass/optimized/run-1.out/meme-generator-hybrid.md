...
Memes live and die by their images, and I didn't want to hand-curate a list. Imgflip has a public endpoint that returns the most popular meme templates, so we'll lean on that. The request itself is easy. The tricky bit is making sure React doesn't fire it a few thousand times.
...
And that's it, you've got a working meme generator. If you build something ridiculous with this, I want to see it.
