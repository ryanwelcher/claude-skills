...
In this recipe, we're building a meme generator block. You'll connect to a third-party meme API, let people add their own text, and register some custom fonts so the punchline actually lands. This one's a lot of fun.
...
Part of what makes memes great is the font. Nobody takes a meme seriously in Times New Roman. A plugin can't install fonts for you, but it can offer a collection that people install in a couple of clicks, and that's kind of the nicer experience anyway.
...
And that's the recipe. If you build something ridiculous with this, I want to see it.
